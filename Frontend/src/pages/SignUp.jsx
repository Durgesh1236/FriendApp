...
const SignUp = () => {
    const { SignUp, btnLoading} = UserData();
  ...
  const handlesignup = (e) => {
    e.preventDefault()
    SignUp(signupData.name, signupData.mobileno, signupData.email, signupData.password, navigate);
  }
  return (
